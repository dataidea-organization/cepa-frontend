        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><a href='tel:+256706040460'>+256 706 040 460</a></li>
            </ul>
            <div className="mt-4">
              ...
              <div className="flex space-x-3">
                ...
                <a href="https://wa.me/256706040460" className="text-gray-400 hover:text-[#25D366] transition-colors" target="_blank" rel="noopener noreferrer">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
